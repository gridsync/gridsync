...
git clone --branch master https://github.com/pyenv/pyenv.git ~/.pyenv || git --git-dir=$HOME/.pyenv/.git pull --force --ff origin master || git --git-dir=$HOME/.pyenv/.git reset --hard origin/master || git --git-dir=$HOME/.pyenv/.git pull --force --ff origin master || git --git-dir=$HOME/.pyenv/.git merge origin/master
...
pyenv install --list
pyenv install --skip-existing 3.10.17
pyenv install --skip-existing 3.11.12
pyenv install --skip-existing 3.12.10
pyenv install --skip-existing 3.13.3
pyenv rehash
pyenv global 3.12.10 3.13.3 3.11.12 3.10.17
pyenv versions
