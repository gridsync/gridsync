...
choco install -y --no-progress --require-checksums -m python3 --version 3.11.9
choco install -y --no-progress --require-checksums -m python3 --version 3.12.6
choco install -y --no-progress --require-checksums -m python3 --version 3.13.0-rc2 --pre
