...
from PyQt5.QtCore import pyqtSignal, QPropertyAnimation, Qt, QThread
from PyQt5.QtGui import QColor, QPainter, QPixmap
from PyQt5.QtWidgets import (
    QCheckBox, QComboBox, QDialogButtonBox, QFileDialog, QFormLayout,
    QGridLayout, QGroupBox, QLabel, QLineEdit, QPlainTextEdit, QProgressDialog,
    QPushButton, QSizePolicy, QSpacerItem, QSpinBox, QWidget)
