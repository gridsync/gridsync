...
# Form implementation generated from reading ui file 'designer/new_folder.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.folder_text = QtGui.QLineEdit(self.select_folder_group_box)
        self.folder_text.setObjectName(_fromUtf8("folder_text"))
        self.horizontalLayout_2.addWidget(self.folder_text)
        self.browse_button = QtGui.QPushButton(self.select_folder_group_box)
