...
in-podman-container:
	podman run --mount type=bind,src=$$(pwd),target=/gridsync -w /gridsync crwood/gridsync-builder

in-docker-container:
	docker run --mount type=bind,src=$$(pwd),target=/gridsync -w /gridsync crwood/gridsync-builder
