...
def core():
    ...
    gateway.magic_folder.magic_folders["TestFolder"] = {
        ...
        "author": {
            "name": "BOB",
            "signing_key": "SIGNINGKEY12=",
            "verify_key": "VERIFYKEY34==",
        },
    }
    gateway.magic_folder.magic_folders["CatPics"] = {
        ...
        "author": {
            "name": "ALICE",
            "signing_key": "SIGNINGKEY56=",
            "verify_key": "VERIFYKEY78==",
        },
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("BOB", "Folder:1:1:AuthorName"),
        ("SIGNINGKEY12=", "Folder:1:1:AuthorSigningKey"),
        ("VERIFYKEY34==", "Folder:1:1:AuthorVerifyKey"),
        ...
        ("ALICE", "Folder:1:2:AuthorName"),
        ("SIGNINGKEY56=", "Folder:1:2:AuthorSigningKey"),
        ("VERIFYKEY78==", "Folder:1:2:AuthorVerifyKey"),
        (os.path.expanduser("~"), "HomeDir"),
